...
public class Mixer extends JFrame implements KeyListener{
	...
	public Mixer() {
	    ...
	    b41.setBackground(Color.magenta);
	    ...
	    b43.setBackground(Color.magenta);
	    ...
	    b47.setBackground(Color.magenta);
